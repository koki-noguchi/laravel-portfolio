...
Route::put('/post/{post}/bookmark', 'BookmarkController@bookmark')->name('bookmark.add');
Route::delete('/post/{post}/bookmark', 'BookmarkController@deleteBookmark')->name('bookmark.delete');
